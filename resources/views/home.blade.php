...
<body>
    <div class="bg-white">
        <x-modal name="homepage-modal" show="{{ false }}" max-width="2xl" focusable>
            <div>
                <h2 class="text-2xl font-bold text-gray-900">Welcome to the homepage!</h2>
                <p class="mt-4 text-gray-500">This is a modal component. You can put any content you like here.</p>
            </div>

            <button type="button" command="close-modal" commandfor="homepage-modal" class="mt-6 inline-flex items-center rounded-md border border-transparent bg-indigo-600 px-4 py-2 text-sm font-medium text-white hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2">
                Close
            </button>
        </x-modal>
                            ...
                            <div>
                                <div class="flex h-16 items-center justify-between">
                                            ...
                                            <div class="flex h-full justify-center space-x-8">
                                                <div class="group/popover flex">
                                                    <div class="relative flex">
                                                        <button popovertarget="desktop-menu-women" class="relative flex items-center justify-center text-sm font-medium text-white transition-colors duration-200 ease-out">
                                                            Women
                                                            <span aria-hidden="true" class="absolute inset-x-0 -bottom-px z-30 h-0.5 bg-transparent duration-200 ease-in group-has-open/popover:bg-white group-has-open/popover-group:duration-150 group-has-open/popover-group:ease-out"></span>
                                                        </button>
                                                    </div>
                                                ...
                                                <div class="group/popover flex">
                                                    <div class="relative flex">
                                                        <button popovertarget="desktop-menu-men" class="relative flex items-center justify-center text-sm font-medium text-white transition-colors duration-200 ease-out">
                                                            Men
                                                            <span aria-hidden="true" class="absolute inset-x-0 -bottom-px z-30 h-0.5 bg-transparent duration-200 ease-in group-has-open/popover:bg-white group-has-open/popover-group:duration-150 group-has-open/popover-group:ease-out"></span>
                                                        </button>
                                                    </div>
                                    ...
                                    <div class="flex flex-1 items-center lg:hidden">
                                        <button type="button" command="show-modal" commandfor="mobile-menu" class="-ml-2 p-2 text-white">
        ...
        <x-button.simple>
            <form>
                <input type="text" name="name" placeholder="Name" class="border bg-gray-500" />
            </form>
        </x-button.simple>

        <x-button.simple message="Category See All" variant="primary">
            <div class=" border rounded bg-red-200 text-red-700">
                This is a test alert
            </div>
        </x-button.simple>

        <x-button.simple message="Before Footer" variant="secondary" />
                    ...
                    <div class="-my-2">
                        <div class="relative box-content h-80 overflow-x-auto py-2 xl:overflow-visible">
                            <div class="absolute flex space-x-8 px-4 sm:px-6 lg:px-8 xl:relative xl:grid xl:grid-cols-5 xl:gap-x-8 xl:space-x-0 xl:px-0">
                                <x-category-item link="#" image="https://tailwindcss.com/plus-assets/img/ecommerce-images/home-page-01-category-01.jpg" title="New Arrivals" />
                                <x-category-item link="#" image="https://tailwindcss.com/plus-assets/img/ecommerce-images/home-page-01-category-02.jpg" title="Best Sellers" />
                                <x-category-item link="#" image="https://tailwindcss.com/plus-assets/img/ecommerce-images/home-page-01-category-03.jpg" title="Sale Items" />
                                <x-category-item link="#" image="https://tailwindcss.com/plus-assets/img/ecommerce-images/home-page-01-category-04.jpg" title="Featured" />
                                <x-category-item link="#" image="https://tailwindcss.com/plus-assets/img/ecommerce-images/home-page-01-category-05.jpg" title="Limited Edition" />
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="py-20 xl:grid xl:grid-cols-3 xl:gap-8">
                    ...
                    <div class="mt-12 md:mt-16 xl:mt-0">
                        ...
                        <form class="mt-2 flex sm:max-w-md">
                            <input id="email-address" type="text" required autocomplete="email" aria-label="Email address" class="block w-full rounded-md bg-white px-4 py-2 text-base text-gray-900 outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline-2 focus:outline-offset-2 focus:outline-white" />
